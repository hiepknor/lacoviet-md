                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-7">
                                            <div class="form-group bmd-form-group">
                                            <textarea type="text" name="description" class="form-control" aria-label="Slug" aria-describedby="inputGroupMaterial-sizing-default">{{$category->description}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
