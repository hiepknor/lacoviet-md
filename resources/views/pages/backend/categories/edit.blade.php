                                    ...
                                    <div class="w-100">
                                        <div class="input-group mb-3 col-md-6">
                                            ...
                                            <label class="switch ml-4">
                                                <input type="checkbox" name="status" value="{{$category->status}}" {{$category->status == '1' ? 'checked' : ''}}>
                                        ...
                                        <div class="input-group mb-3 col-md-6">
                                            ...
                                            <input type="text" required name="name" class="form-control ml-4" aria-label="Name" aria-describedby="inputGroupMaterial-sizing-default" value="{{$category->name}}">
                                        </div>
                                        <div class="input-group mb-3 col-md-6">
                                            <div class="input-group-prepend col-md-4">
                                                <span class="input-group-text md-addon" id="inputGroupMaterial-sizing-default">Slug</span>
                                            </div>
                                            <input type="text" required name="slug" class="form-control ml-4" aria-label="Slug" aria-describedby="inputGroupMaterial-sizing-default" value="{{$category->slug}}">
                                        </div>
                                        <div class="input-group mb-3 col-md-6">
                                            <div class="input-group-prepend col-md-4">
                                                <span class="input-group-text md-addon" id="inputGroupMaterial-sizing-default">Description</span>
                                            </div>
                                            <textarea type="text" name="description" class="form-control ml-4" aria-label="Slug" aria-describedby="inputGroupMaterial-sizing-default">{{$category->description}}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </form>
