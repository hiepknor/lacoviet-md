@extends('layouts.backend', ['activePage' => 'users', 'titlePage' => __('Users')])
...
@section('content')
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="post" action="{{ route('backend.users.update', $user) }}" autocomplete="off" class="form-horizontal">
            @csrf
            @method('put')
              ...
              <div class="card-body ">
                <div class="row">
                  <div class="col-md-12 text-right">
                      <a href="{{ route('backend.users.index') }}" class="btn btn-sm btn-primary">{{ __('Back to list') }}</a>
                  </div>
                </div>
                <div class="row">
